...
public class SearchFriendsBackgroundWorker extends AsyncTask<String, Void, String> {

    Context context;
    String username;

    SearchFriendsBackgroundWorker(Context c){context = c;}

    @Override
    protected String doInBackground(String... params) {
        username = params[0];
        try{
            URL url = new URL("http://jesseareyes1996.hostingerapp.com/vocality_search_friends.php");
            //open the connection
    ...
    protected void onPostExecute(String result) {
        ...
        if(result.equals("No user found!")){
            ...
            Button addFriendsBtn = (Button)((Activity)context).findViewById(R.id.addFriendsBtn);
